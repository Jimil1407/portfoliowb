...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-3 md:top-6 left-1/2 -translate-x-1/2 z-50 animate-navbar-bounce w-full max-w-xl" style={{ transform: 'translateX(-50%)' }}>
      <div className="bg-black/60 backdrop-blur-2xl border border-white/20 rounded-full px-2 py-4 md:px-6 md:py-2 shadow-2xl flex items-center justify-between">
